...
- **2026-07-11** — Week-1 safety fixes implemented (rollout W1–W7, on PR #8): "emergency" purged from demo (Rapid Ride / Same-Night Shelter / Veteran Support Services), persistent in-frame DEMO banner + honest confirmation copy, crisis bar now sticky with header (verified via Playwright desktop+375px), tappable sms:838255 everywhere, shared `SafetyNote` component replacing inconsistent warn notes, footer crisis routing, dead IRS-letter link → IRS Tax-Exempt Org Search, App Demo meta copy/dead links cleaned — build green (15 pages); brand-kit summary doc also created on founder's Google Drive
