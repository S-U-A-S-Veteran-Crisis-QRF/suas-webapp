...
- **2026-07-11** — Dependabot alert #1 patched: postcss forced to ≥8.5.10 (was 8.4.31 via `next`, XSS advisory GHSA-qx2v-qp2m-jg93) with an npm `overrides` entry; `npm audit` clean, static export verified
