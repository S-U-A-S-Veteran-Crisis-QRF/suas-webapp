...
- **2026-07-30** — Veterans Innovation Hackathon promoted on the site: new `/hackathon` page (agenda, who-we-need, judging/awards, public sponsorship tiers, Luma registration CTA, `Event` JSON-LD), a `HackathonForm` routing mentor/judge/sponsor/partner interest into the shared inbox, home-page promo band, and header/footer nav entries. Header nav made 8-item-safe (`.nav` min-height + tighter link gap; header label "App Demo" → "Demo")
