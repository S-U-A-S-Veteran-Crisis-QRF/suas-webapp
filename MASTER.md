...
- **2026-07-31** — Printable hackathon flyer shipped: `/hackathon-flyer` (unlisted, `noindex`) renders a one-page US-Letter recruitment/sponsor sheet for the **Veterans Innovation Hackathon, Aug 28–30 2026 at Hacker Dojo**, with a registration QR (`luma.com/Innovation4Veterans`), roles needed, the 3-day arc, and the 988 crisis line twice on the sheet; pre-rendered `public/docs/hackathon-flyer-2026.pdf` (1 page, verified via headless Chromium) for anyone who just needs the file
