...
export default function DonatePage() {
  // Plain <a href="/..."> ignores basePath, so the sub-path deploy needs it
  // prefixed explicitly (same pattern as app/app/page.tsx).
        ...
        <div className="container">
          <Reveal className="card lift" style={{ maxWidth: 760, margin: "0 auto" }}>
            ...
            <p className="note" style={{ marginTop: 12 }}>
              <a
                href={`${base}/docs/IRS-Determination-Letter.pdf`}
                target="_blank"
